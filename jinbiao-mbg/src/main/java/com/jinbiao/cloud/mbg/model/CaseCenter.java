...
public class CaseCenter implements Serializable {
    ...
    @ApiModelProperty(value = "案情来源code码")
    private Integer caseSourceCode;

    @ApiModelProperty(value = "案源是否来自于案情卡填写标志：0-否；1-是")
    private Byte imCaseCardFlag;
    ...
    public Integer getCaseSourceCode() {
        return caseSourceCode;
    }

    public void setCaseSourceCode(Integer caseSourceCode) {
        this.caseSourceCode = caseSourceCode;
    }

    public Byte getImCaseCardFlag() {
        return imCaseCardFlag;
    }

    public void setImCaseCardFlag(Byte imCaseCardFlag) {
        this.imCaseCardFlag = imCaseCardFlag;
    }
    ...
    public String toString() {
        ...
        sb.append(", caseSourceCode=").append(caseSourceCode);
        sb.append(", imCaseCardFlag=").append(imCaseCardFlag);
        sb.append(", callOutFlag=").append(callOutFlag);
        sb.append(", disable=").append(disable);
        sb.append(", caseCirculateStatus=").append(caseCirculateStatus);
        sb.append(", oldCaseId=").append(oldCaseId);
        ...
        sb.append(", loanDemand=").append(loanDemand);
