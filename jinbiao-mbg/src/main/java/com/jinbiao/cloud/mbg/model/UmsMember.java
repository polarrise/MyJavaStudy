...
public class UmsMember implements Serializable {
    ...
    @ApiModelProperty(value = "帐号启用状态:0->禁用；1->启用；2->注销")
    ...
    @ApiModelProperty(value = "im排队得分")
    private Integer score;

    @ApiModelProperty(value = "是否电话授权：1=是；0=否；")
    private Byte hasPhoneAuth;

    @ApiModelProperty(value = "小法盾余额")
    private Integer overage;

    @ApiModelProperty(value = "知识卡片剩余次数")
    private Integer cardCount;

    @ApiModelProperty(value = "机构ID")
    private Long eventId;

    @ApiModelProperty(value = "启用个性化推荐")
    private Boolean enableRecommendation;

    @ApiModelProperty(value = "是否列入禁拨名单标志：0-否，1-是")
    ...
    public Byte getHasPhoneAuth() {
        return hasPhoneAuth;
    }

    public void setHasPhoneAuth(Byte hasPhoneAuth) {
        this.hasPhoneAuth = hasPhoneAuth;
    }
    ...
    public void setEnableRecommendation(Boolean enableRecommendation) {
    ...
    public String toString() {
        ...
        sb.append(", hasPhoneAuth=").append(hasPhoneAuth);
        sb.append(", overage=").append(overage);
        sb.append(", cardCount=").append(cardCount);
        sb.append(", eventId=").append(eventId);
        sb.append(", enableRecommendation=").append(enableRecommendation);
