...
public class UserServiceInferConstruct {
   ...
   * 2.使用orderService123会报错，Spring先通过类型找到有三个Bean,然后通过名字找不到就报错：Caused by: org.springframework.beans.factory.NoUniqueBeanDefinitionException: No qualifying bean of type 'com.jinbiao.spring_study.service.OrderService' available: expected single matching bean but found 3: orderService,orderService1,orderService2
